...
insert into public.desks (nombre, zona, pos_x, pos_y) values
    ('D2',   'Proyectos',   200, 100),
    ('D3',   'Proyectos',   300, 100),
    ('D4',   'Proyectos',   400, 100),
    ('D5',   'Proyectos',   500, 100),
    ('D6',   'Proyectos',   600, 100),
    ('D8',   'Proyectos',   200, 220),
    ('D9',   'Proyectos',   300, 220),
    ('D10',  'Proyectos',   400, 220),
    ('D11',  'Proyectos',   500, 220),
    ('D12',  'Proyectos',   600, 220),
    ('D13',  'Proyectos',   700, 220),
    ('D14',  'Proyectos',   800, 220),
